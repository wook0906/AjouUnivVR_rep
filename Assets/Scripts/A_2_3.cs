...
public class A_2_3 : BaseScene, ISceneControl
{
    ...
    IEnumerator Take1()
    {
        ...
        {
            case 1:
                actors["AYun"].Say("12_a1_2", Define.AnimationLayerType.A_2);
                actors["AYun"].Anim.CrossFade("12_a1_2", 0.1f);
                yield return new WaitUntil(() => Managers.Observer.IsCharactersAudioDone(Define.CharacterType.AYun));
                break;
            case 2:
                actors["AYun"].Say("12_a2_1", Define.AnimationLayerType.A_2);
                actors["AYun"].Anim.CrossFade("12_a2_1", 0.1f);
                yield return new WaitUntil(() => Managers.Observer.IsCharactersAudioDone(Define.CharacterType.AYun));
                DirectorUI.S.CreateChoiceBranch(Define.BranchType.A_2_2);
                yield break;
            default:
                break;
        }
        DirectorUI.S.CreateChoiceBranch(Define.BranchType.A_2_3);
    }
